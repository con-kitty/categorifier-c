...
module Categorifier.C.Prim.ArrayLens
...
import Categorifier.C.Prim.ArrayCount (ArrayCount, _ArrayCount)
import Categorifier.C.Prim.Base (Arrays, IsPrimitive, prims_)
