...
module Categorifier.C.Prim.Helpers
...
import Categorifier.C.Prim.ArrayName (ArrayName (..))
import Categorifier.C.Prim.Base (Arrays, IsPrimitive (..), Prim, PrimType, PrimVal, polyIndexArrays)
import Categorifier.C.Prim.Patterns
  ( pattern BoolType,
    pattern DoubleType,
    pattern FloatType,
    pattern Int16Type,
...
-- 'Categorifier.C.Prim.Base.Arrays'.
