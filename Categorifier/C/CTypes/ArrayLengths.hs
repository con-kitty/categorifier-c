...
module Categorifier.C.CTypes.ArrayLengths
  ( arrayLengthsCType,
    arrayLengthsCCon,
    primArrayCount,
    maxUnionConLengths,
...
import Categorifier.C.CTypes.Types (CCon, CType, CUnion, CUnionF (..), Prim (..))
import Categorifier.C.Prim (ArrayCount (..), ArrayName (..), Arrays (..), PrimLens, arrayNames, prims_)
