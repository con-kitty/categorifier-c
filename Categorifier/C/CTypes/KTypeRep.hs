...
module Categorifier.C.CTypes.KTypeRep
  ( KTypeRep,
    toKTypeRep,
    splitKTyConApp,
...
import Categorifier.C.Prim (allPrimTypes, getIsPrimitiveRep, getPrimCName)
...
isC tyCon
  | show tyCon /= "C" = False
  | tyConModule tyCon == "Categorifier.C.KTypes.C" = True
