...
-- __TODO__: Make them non-orphans and get rid of @import Categorifier.C.CExpr.FunctionCall ()@
{-# OPTIONS_GHC -Wno-orphans #-}

module Categorifier.C.CExpr.FunctionCall
  ( computeSpec,
    mkInputIndices,
    mkInputs,
  )
...
import qualified Categorifier.C.CExpr.Types.Core as CExpr
...
import Categorifier.C.Prim (ArrayCount (..), Arrays, IsPrimitive)
