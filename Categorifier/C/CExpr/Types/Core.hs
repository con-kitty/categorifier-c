...
module Categorifier.C.CExpr.Types.Core
  ( Callee (..),
    FunctionCall (..),
    Select (..),
    PrimTypeLens,
...
import Categorifier.C.CExpr.Types (CExprFunctionCall, CExprSelectExpression, CExprTypeLens)
import Categorifier.C.CExpr.Types.Operations
  ( BoolBinOp (..),
    BoolUnOp (..),
    CmpOp (..),
    FPBinOp (..),
...
import Categorifier.C.Recursion (HFix, hembed)
...
--      on the operation at hand, we may index into a `Categorifier.C.CExpr.Types.CExprTypeProduct` (a
...
instance CGeneric (CExpr Bool) where
  type
    Rep (CExpr Bool) =
      CG.PrimRep "CExprBool" "Categorifier.C.KTypes.CExpr" "cexpr-types" (CExpr Bool)
  from = CG.primFrom
  to = CG.primTo
...
instance CGeneric (CExpr Int8) where
  type
    Rep (CExpr Int8) =
      CG.PrimRep "CExprInt8" "Categorifier.C.KTypes.CExpr" "cexpr-types" (CExpr Int8)
  from = CG.primFrom
  to = CG.primTo
...
instance CGeneric (CExpr Int16) where
  type
    Rep (CExpr Int16) =
      CG.PrimRep "CExprInt16" "Categorifier.C.KTypes.CExpr" "cexpr-types" (CExpr Int16)
  from = CG.primFrom
  to = CG.primTo
...
instance CGeneric (CExpr Int32) where
  type
    Rep (CExpr Int32) =
      CG.PrimRep "CExprInt32" "Categorifier.C.KTypes.CExpr" "cexpr-types" (CExpr Int32)
  from = CG.primFrom
  to = CG.primTo
...
instance CGeneric (CExpr Int64) where
  type
    Rep (CExpr Int64) =
      CG.PrimRep "CExprInt64" "Categorifier.C.KTypes.CExpr" "cexpr-types" (CExpr Int64)
  from = CG.primFrom
  to = CG.primTo
...
instance CGeneric (CExpr Word8) where
  type
    Rep (CExpr Word8) =
      CG.PrimRep "CExprWord8" "Categorifier.C.KTypes.CExpr" "cexpr-types" (CExpr Word8)
  from = CG.primFrom
  to = CG.primTo
...
instance CGeneric (CExpr Word16) where
  type
    Rep (CExpr Word16) =
      CG.PrimRep "CExprWord16" "Categorifier.C.KTypes.CExpr" "cexpr-types" (CExpr Word16)
  from = CG.primFrom
  to = CG.primTo
...
instance CGeneric (CExpr Word32) where
  type
    Rep (CExpr Word32) =
      CG.PrimRep "CExprWord32" "Categorifier.C.KTypes.CExpr" "cexpr-types" (CExpr Word32)
  from = CG.primFrom
  to = CG.primTo
...
instance CGeneric (CExpr Word64) where
  type
    Rep (CExpr Word64) =
      CG.PrimRep "CExprWord64" "Categorifier.C.KTypes.CExpr" "cexpr-types" (CExpr Word64)
  from = CG.primFrom
  to = CG.primTo
...
instance CGeneric (CExpr Float) where
  type
    Rep (CExpr Float) =
      CG.PrimRep "CExprFloat" "Categorifier.C.KTypes.CExpr" "cexpr-types" (CExpr Float)
  from = CG.primFrom
  to = CG.primTo
...
instance CGeneric (CExpr Double) where
  type
    Rep (CExpr Double) =
      CG.PrimRep "CExprDouble" "Categorifier.C.KTypes.CExpr" "cexpr-types" (CExpr Double)
  from = CG.primFrom
  to = CG.primTo
