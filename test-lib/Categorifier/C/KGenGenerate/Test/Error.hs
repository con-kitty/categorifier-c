...
-- | The `Categorifier.C.KTypes.Conditional.KSelect` class's interface leaves a lot of ways for things to go
...
-- | An internal "impossible" situation occurred in a `Categorifier.C.KTypes.Conditional.KSelect` instance;
-- throw an exception.
