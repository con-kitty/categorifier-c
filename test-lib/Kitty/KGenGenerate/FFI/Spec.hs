...
module Kitty.KGenGenerate.FFI.Spec
  ( -- * Function specs
    genFunSpec,
    cgStateToSpec,
...
import Kitty.Codegen.FFI.Spec (FFIArrayCount (..), SBVFFISpec, Spec (..), arrayCountsToSpec)
import Kitty.Prim (ArrayCount, Arrays, HasArrays (..), countLenses, _ArrayCount)
